...
namespace webMAN_Manager
{
    ...
    {/// <summary>
     ...
     /// </summary>
        ...
        {
            _logname = $"[{typeof(PS3System).Assembly.GetName().Name}|{Environment.UserName}]";
        ...
        private void W(string msg) => Data.Log(_logname + " " + msg);
        /// <summary>
        /// Revalidates all information for the client and updates all his fields.
        /// </summary>
        /// <exception cref="InvalidOperationException"></exception>
        public void Retrieve(EventHandler onFinished = null)
        {
            ...
            void SetInfo()
            {
                ...
                else
                {
                    ...
                    W("html loaded.");
                    W(((long)html.Length * (sizeof(char))).ToBytesRepresentationString());
                    if (flag)
                    {
                        ...
                        _mem = mem.InnerText;
                        string game = "XMB";
                        W("html nodes downloaded.");
                        if (nodes.Length > 4)
                        {
                            W("nodes.Length > 4 & (!isonxmb) == true");
                            ...
                            if (ingame is true)
                            {
                                ...
                                W("Cleaning and fetching last info...");
        ...
        {
            MessageBox.Show($"Exception caught of type: {error.GetType().Name}\nWith message: {error.Message}\nAt source: {error.Source}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        /// <summary>
        ...
        public void Notification(string message, int icon, int snd)
        {
            ...
            string cmd = string.Format(basefo, HttpUtility.HtmlEncode(message), icon, snd);
