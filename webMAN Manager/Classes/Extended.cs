...
namespace System
{
    internal static class ExtensionsTypes
    {
        ...
        public static void SetBorder(this Control ctl, Color col, int width, BorderStyle style)
        {
        ...
        public static Point GetCenter(this Size sender, int pluswidth = 0, int plusheight = 0)
        {
            return new Point((sender.Width / 2) + pluswidth, (sender.Height / 2) + plusheight);
        }
        public static bool IsOnRange(this Size input, Size check, int part)
        {
            var checkAr = check.Width + check.Height;
            var inputAr = input.Width + input.Height;
            return inputAr / part < checkAr;
        }
        ...
        public static Point GetCenter(this System.Windows.Forms.Form snd, Control target)
        {
            return new Point((snd.Width / 2) - (target.Width / 2), (snd.Height / 2) - (target.Height / 2));
        }
